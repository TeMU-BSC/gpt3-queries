...
the_table=plt.table(cellText=vals, rowLabels=df.index, colLabels=['1st', '2nd', '3rd','4th','5th'], 
                    ...
                    cellColours=colours)
the_table.scale(2,2)
plt.text(0.29, 2.63, 'English', horizontalalignment='center', verticalalignment='center', transform=ax.transAxes, fontweight='bold')
...
the_table=plt.table(cellText=vals, rowLabels=df.index, colLabels=['1st', '2nd', '3rd','4th','5th'], 
                    ...
                    cellColours=colours)
the_table.scale(2,2)
plt.text(0.29, -0.15, 'Catalan', horizontalalignment='center', verticalalignment='center', transform=ax.transAxes, fontweight='bold')
